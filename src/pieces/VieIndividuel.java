...
public class VieIndividuel {
	...
	public void save(ActionEvent event) throws IOException  {
		...
		parameter.put("officer", MyUtil.getUserLogged().getUserPrenom()+" "+MyUtil.getUserLogged().getUserNom());
		...
		try {
			...
			if(dService.addPiece(pService.findByCode(230))){
				...
				String reportSource = context.getExternalContext().getRealPath("ActeNPDF/pieces/certifiactVieIndividuel.jasper");
